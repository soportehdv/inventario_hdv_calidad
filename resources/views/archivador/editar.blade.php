...
@section('title', 'Editar archivador')
@section('content_header')
    <div class="card" style="height:4em;">
        <div class="card-header">
            <h2>Editar archivador</h2>
        </div>
    </div>
@endsection
@section('content')
    ...
    <div class="container">
        ...
        <div class="col-sm-7 center_margin">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('Archivador.update', $Files->id) }}">
                        @csrf
